...
final class DeviceProvider: ObservableObject {
    ...
    private func checkLowBattery() {
        ...
        content.body = "Your jarvis device is running low on battery. Time for a recharge! 🔋"
    ...
    private func sendDisconnectNotification() {
        let content = UNMutableNotificationContent()
        content.title = "Your jarvis Device Disconnected"
        content.body = "Please reconnect to continue using your jarvis."
        content.sound = .default
...
extension DeviceProvider: DeviceConnectionDelegate {
    ...
    nonisolated func deviceConnection(_ connection: DeviceConnection, didDetectFall data: AccelerometerData) {
        Task { @MainActor in
            ...
            content.body = "A potential fall was detected by your jarvis device."
            content.sound = .default
