    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 20) {
                ...
                // Description
                VStack(spacing: 8) {
                    Text("Unlock Jarvis Pro for $199/month")
                        .scaledFont(size: 15, weight: .medium)
                        .foregroundColor(OmiColors.textPrimary)
                        .multilineTextAlignment(.center)

                    Text("Your browser will open to the Jarvis Pro checkout. After subscribing, return to Jarvis.")
                        .scaledFont(size: 13)
                        .foregroundColor(OmiColors.textTertiary)
                        .multilineTextAlignment(.center)
            ...
            VStack(spacing: 12) {
                Button(action: {
                    ...
                    HStack(spacing: 8) {
                        ...
                        Text(isConnecting ? "Opening checkout..." : "Upgrade to Jarvis Pro")
